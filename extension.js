//Strings
const CFG_SECTION = "caniuseQuery";
const CFG_QUERY = "QueryTemplate";
const CMD_ID = "extension.caniuseQuery";
...
function webSearch() {
  ...
  let caniuseQueryCfg = vscode.workspace.getConfiguration(CFG_SECTION);
  const queryTemplate = caniuseQueryCfg.get(CFG_QUERY);
